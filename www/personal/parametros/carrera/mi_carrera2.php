          ...
          function abrir_docu(id){
            var iddocu = id;
              iddocu = iddocu + ".pdf";
                ...
                //window.open('http://200.68.34.158/testing/personal/pdf/saf.php?id='+idSAF,'_blank');
          }
          
            function puntoscriticos(){
              window.open('http://200.68.34.158/personal/php/carrera/puntos_criticos.php','_blank',"width=650,height=450");
            } 
        </script>
    </head>
    <body onload="cargar();">
