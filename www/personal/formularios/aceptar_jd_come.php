            ...
            <div class="section">
                <div class="row">
                    <div class="col s12 center block" style="background-color: #ffffff">
                        <h4 class="light">Aceptar Cometido</h4>
                        <div class="row">
        ...
        <?php
            if($_POST['aceptar'] == "Autorizar"){
                ...
                if($opcion == "JDyDIR"){
                    ...
                    $actualizarAcu = "UPDATE COME_PERMI SET CO_ESTA = 'AUTORIZADO DIR',USU_RUT_DIR = '$Srut'  WHERE (CO_ID = '$co_id')";
                    ...
                    $insertAccion = "INSERT INTO HISTO_PERMISO (HP_FOLIO, USU_RUT, HP_FEC, HP_HORA, DOC_ID, HP_ACC) VALUES ($co_id,'$usu_rut','$Actualfecha','$Actualhora',$doc_id,'$accionRealizada')";
                    mysqli_query($cnn, $insertAccion);
                }else{
                    //cambiar estado a V.B. J.D.
                    $actualizarAcu = "UPDATE COME_PERMI SET CO_ESTA = 'V.B. J.D.',USU_RUT_DIR = '$opcion'  WHERE (CO_ID = '$co_id')";
                    mysqli_query($cnn, $actualizarAcu);
