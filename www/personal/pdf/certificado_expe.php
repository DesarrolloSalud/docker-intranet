    ...
    if(!isset($_SESSION['USU_RUT'])){
        ...
        $pdf->MultiCell(165,5,$texto,'J');
				...
				$y = $pdf->GetY();
				 ...
				 $query = "SELECT DATE_FORMAT(CB_FEC_INI,'%d-%m-%Y'),DATE_FORMAT(CB_FEC_FIN,'%d-%m-%Y'),CB_CALJURI,CB_NUM_DOC,CB_INDEFI,USU_CAT,CB_ESTABLE FROM CARRERA_BIENIO WHERE (USU_RUT = '".$idrut."') AND CB_ESTADO ='1'  ORDER BY CB_FEC_INI";
