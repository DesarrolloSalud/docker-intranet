<?php 
    ...
    if(!isset($_SESSION['USU_RUT'])){
      ...
      $iddocu ="SELECT CO_ID,DOC_ID,COME_PERMI.USU_RUT,USUARIO.USU_NOM,USUARIO.USU_APP,USUARIO.USU_APM,USUARIO.USU_CAT,USU_RUT_JD,CO_VIA,CO_PAS,CO_PEA,CO_PAR,CO_MOT,CO_DES,CO_DIA,CO_COM,USUARIO.USU_FIR,USU_RUT_DIR,USUARIO.USU_CAR,USUARIO.EST_ID FROM COME_PERMI INNER JOIN USUARIO ON COME_PERMI.USU_RUT=USUARIO.USU_RUT WHERE (CO_ID ='$coid')";
      $respuesta = mysqli_query($cnn, $iddocu);
      ...
      $pdf->Ln(10);
			...
			$pdf->Ln(10);
			$DetalleCometido = "SELECT DATE_FORMAT(CD_DIA, '%d-%m-%Y'),CD_HORA_INI,CD_HORA_FIN,CD_POR FROM COME_DETALLE WHERE (CO_ID ='$coid')";
