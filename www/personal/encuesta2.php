<?php
	...
	if(!isset($_SESSION['USU_RUT'])){
        ...
        $fecha = date("Y-m-d");
        $hora = date("H:i:s");
        $reponder = "SELECT RUT,CAT,EST FROM HC2021 WHERE (RUT = '$Srut' AND ESTADO_2 = 'PENDIENTE')";
        ...
        <script>
            ...
            function enviar(){
                ...
                if(voto3 != "no"){
                    ...
                    M.toast({html: 'debe seleccionar una opcion'});
                }
            }
    ...
    <body onload="Cargar();">
                        ...
                        <div class="row">
                            ...
                            <?php
                                ...
                                echo '<div class="input-field col s12">';
                                    echo '<select name="voto3" id="voto3" onchange="enviar();">';
                                    ...
                                    echo '</select>';
                                echo '<label for="voto1">Voto 3</label>';
                                echo '</div>';
                            ?>
        ...
        <?php
            if($_POST['aceptar'] == "Autorizar"){
                $voto3 = $_POST['voto3'];
                $insertAccion = "UPDATE HC2021 SET ESTADO_2 = 'LISTO', VOTO3 = '$voto3' WHERE RUT = '$Srut'";
