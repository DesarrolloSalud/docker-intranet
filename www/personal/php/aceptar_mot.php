<?php
    ...
    $actualizarauot = "UPDATE OT_EXTRA_ENC SET  OEE_ESTA = 'AUTORIZADO DIR' WHERE (OEE_ID= '$id')";
    mysqli_query($cnn,$actualizarauot);
    $accionRealizada = utf8_decode("AUTORIZADO COMO DIRECTOR POR :  ".$Snombre." ".$SapellidoP." ".$SapellidoM);
