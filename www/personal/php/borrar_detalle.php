<?php
    ...
    if(!isset($_SESSION['USU_RUT'])){
    	...
    	$BorrarDetalle = "DELETE FROM OTE_DETALLE WHERE (OE_ID = $oe_id) AND (DATE_FORMAT(OTE_DIA,'%d-%m-%Y') = '$ote_dia') AND (OTE_HORA_INI = '$ote_hora_ini') AND (OTE_HORA_FIN = '$ote_hora_fin')";
