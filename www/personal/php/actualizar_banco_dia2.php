<?php 
    ...
    if(!isset($_SESSION['USU_RUT'])){
        ...
        $fla = $_POST['fla'];
        $sgr = $_POST['sgr'];
        $query_rut = "SELECT USUARIO.USU_RUT, USUARIO.USU_NOM, USUARIO.USU_APP, USUARIO.USU_APM, BANCO_DIAS.BD_ANO FROM BANCO_DIAS, USUARIO WHERE (USUARIO.USU_RUT = BANCO_DIAS.USU_RUT) AND (BANCO_DIAS.BD_ID = $id)";
        ...
        //$Actualizar = "UPDATE BANCO_DIAS_MARCE SET BD_ADM = '$adm',BD_FL = $fl,BD_FLA = $fla,BD_SGR = $sgr WHERE BD_ID = $id";
